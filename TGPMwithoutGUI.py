...
#     root = tk.Tk()
#     root.title("monitoring Telegram chats")
            ...
            if hasattr(message_obj.peer_id, 'user_id'):
                ...
                # отслеживаемых ресурсах, времени ответа
                    ...
                    try:
                        ...
                        files = ['links.txt', 'keywords.txt', 'promo_messages.txt', 'reply_range.txt']
                        uploaded_files = []
...
# start_button = tk.Button(root, text="Начать мониторинг", command=start_monitoring, fg='red')
