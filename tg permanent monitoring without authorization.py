...
try:
    with open('api_id, api_hash, phone.txt', 'r', encoding='utf-8') as api_datas_file, \
        ...
        user_data_lines = api_datas_file.readlines()
        API_ID = int(user_data_lines[0][33:-1])
        API_HASH = user_data_lines[1][35:]
